...
class ilCardPluginGUI extends ilPageComponentPluginGUI
{
    ...
    public function getElementHTML(/* string */ $a_mode, /* array */ $a_properties, /* string */ $a_plugin_version) /* : string */
    {
        ...
        ob_start();
        ?>
        <div class="kalamun-card" data-supportedlp="<?= $supported_lp ?>" data-status="<?= $status; ?>" data-layout="<?= $layout; ?>" data-type="<?= $type; ?>" data-content-type="<?= $content_type; ?>" data-id="<?= $ref_id; ?>" data-has-progress="<?= $has_progress; ?>" data-lp-percent="<?= $lp_percent; ?>" data-has-tests="<?= $has_tests; ?>">
